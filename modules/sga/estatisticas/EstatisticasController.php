...
class EstatisticasController extends ModuleController
{
    ...
    public function __construct(App $app, Modulo $modulo)
    {
        ...
        $this->graficos = array(
            1 => new Grafico(_('Atención por status'), 'pie', 'unidade,date-range'),
            2 => new Grafico(_('Atención por servicio'), 'pie', 'unidade,date-range'),
            3 => new Grafico(_('Tiempo medio de atención'), 'bar', 'unidade,date-range'),
        );
        $this->relatorios = array(
            1 => new Relatorio(_('Servicios Disponibles - General'), 'servicos_disponiveis_global'),
            2 => new Relatorio(_('Servicios Disponibles - Unidad'), 'servicos_disponiveis_unidades', 'unidade'),
            ...
            5 => new Relatorio(_('Atenciones en todos los status'), 'atendimentos_status', 'unidade,date-range'),
            6 => new Relatorio(_('Tiempos medios por operador'), 'tempo_medio_atendentes', 'date-range'),
            7 => new Relatorio(_('Dotaciones'), 'lotacoes', 'unidade'),
