...
class AtendimentoService extends MetaModelService
{
    ...
    {
        return array(
            self::SENHA_EMITIDA => _('Numero emitido'),
            self::CHAMADO_PELA_MESA => _('Llamado por la mesa'),
            ...
            self::SENHA_CANCELADA => _('Numero cancelado'),
            self::ERRO_TRIAGEM => _('Error de selección'),
