 ...
 * @autor 
 */
document.write("<script type='text/javascript' src='http://code.responsivevoice.org/responsivevoice.js'></script>");                                     
angular.module('app', [])
    .controller('PainelCtrl', function($scope, $http) {
        ...
        $scope.ultima = {
            ...
            local: 'Ubicación',
            numeroLocal: 0,
            mensagem: 'Atención al cliente',
            styleClass: 'inactive'
        };
        
		$scope.defaultLang = 'es-ES';
        $scope.senhas = [];
        $scope.historico = [];
    ...
    Speech: {
        ...
        play: function(senha, params) {
            ...
            if (params.vocalizar) {
                ...
                var text = responsiveVoice.speak(tickete + senha.sigla + espacio + senha.numero, "Spanish Latin American Female", {rate: 0.7}, {pitch: 1}, {volume: 1}) + senha.numero;
                ...
                if (params.local) {
                    ...
                    // numero do local
                    var puesto=senha.local
                    var num = responsiveVoice.speak(puesto + senha.numeroLocal, "Spanish Latin American Female", {rate: 0.8}, {pitch: 2}, {volume: 1}) + senha.numeroLocal;
